...
LEFT OUTER JOIN edfi.SectionClassPeriod
    ON SectionClassPeriod.LocalCourseCode = CourseOffering.LocalCourseCode
        AND SectionClassPeriod.SchoolId = Course.EducationOrganizationId
        AND SectionClassPeriod.SchoolYear = CourseOffering.SchoolYear
