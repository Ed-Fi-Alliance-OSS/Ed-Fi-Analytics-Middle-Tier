 ...
 */
CREATE TABLE IF NOT EXISTS analytics_config.ews_LetterGradeTranslation (
	LetterGradeEarned VARCHAR(20) NOT NULL,
	NumericGradeEarned DECIMAL(9,2) NOT NULL,
	CONSTRAINT PK_ews_LetterGradeTranslation PRIMARY KEY (LetterGradeEarned)
...
( 'D', 65.0 ),
( 'F', 55.0 )
ON CONFLICT ON CONSTRAINT PK_ews_LetterGradeTranslation
DO NOTHING;;