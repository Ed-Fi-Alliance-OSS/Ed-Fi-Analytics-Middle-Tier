...
namespace EdFi.AnalyticsMiddleTier.Tests.Classes
{
    ...
    {
        public string SchoolKey { get; set; } //(int, not null)
        ...
        public string LocalEducationAgencyKey { get; set; } //(int, null)
        public string StateEducationAgencyName { get; set; } //(nvarchar(75), not null)
        public string StateEducationAgencyKey { get; set; } //(int, null)
        public string EducationServiceCenterName { get; set; } //(nvarchar(75), not null)
        public string EducationServiceCenterKey { get; set; } //(int, null)
