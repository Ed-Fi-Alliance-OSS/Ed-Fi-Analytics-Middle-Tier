...
namespace EdFi.AnalyticsMiddleTier.Tests.Dimensions.StudentHistoryDimTestGroup
{
    ...
    public abstract class When_querying_the_StudentHistoryDim_view : When_querying_a_view_postgres_ds3
    {
        ...
        {
            (bool success, string errorMessage) testResult = DataStandard.RunTestCase<TableColumns>($"{TestCasesFolder}.{DataStandard.GetTestDataFolderName}.0001_StudentHistoryDim_should_match_column_dictionary.xml");
