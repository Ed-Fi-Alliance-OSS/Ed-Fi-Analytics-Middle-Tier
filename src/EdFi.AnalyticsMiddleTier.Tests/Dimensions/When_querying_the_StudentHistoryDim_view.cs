...
namespace EdFi.AnalyticsMiddleTier.Tests.Dimensions.StudentHistoryDimTestGroup
{
    ...
    public abstract class When_querying_the_StudentHistoryDim_view : When_querying_a_view_postgres_ds3
    {
        ...
        {
            (bool success, string errorMessage) testResult = DataStandard.RunTestCase<TableColumns>($"{TestCasesFolder}.{DataStandard.DataStandardEngine}.0001_StudentHistoryDim_should_match_column_dictionary.xml");
        ...
        {
            [OneTimeSetUp]
            public void PrepareDatabase() => PrepareTestData<StudentHistoryDim>(TestCasesFolder, TestCasesDataFileName, AnalyticsMiddleTier.Common.DataStandard.Ds31, Component.Equity);
        }
