...
namespace EdFi.AnalyticsMiddleTier.Tests.Dimensions.FeederSchoolDimTestGroup
{
    ...
    public abstract class When_querying_the_FeederSchoolDim_view : When_querying_a_view_postgres_ds3
    {
        ...
        {
            (bool success, string errorMessage) testResult = DataStandard.RunTestCase<TableColumns>($"{TestCasesFolder}.{DataStandard.GetTestDataFolderName}.0001_FeederSchoolDim_should_match_column_dictionary.xml");
