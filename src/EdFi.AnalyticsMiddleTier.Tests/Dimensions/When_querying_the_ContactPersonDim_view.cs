...
namespace EdFi.AnalyticsMiddleTier.Tests.Dimensions.ContactPersonDimTestGroup
{
    ...
    public abstract class When_querying_the_ContactPersonDim_view : When_querying_a_view_postgres
    {
        ...
        {
            (bool success, string errorMessage) testResult = DataStandard.RunTestCase<TableColumns>($"{TestCasesFolder}.{DataStandard.DataStandardFolder(false, AnalyticsMiddleTier.Common.DataStandard.Ds31)}.0001_ContactPersonDim_should_match_column_dictionary.xml");
        ...
        {
            [OneTimeSetUp]
            public void PrepareDatabase() => PrepareTestData<ContactPersonDim>(TestCasesFolder, TestCasesDataFileName, true, AnalyticsMiddleTier.Common.DataStandard.InvalidDs, null);
        }
