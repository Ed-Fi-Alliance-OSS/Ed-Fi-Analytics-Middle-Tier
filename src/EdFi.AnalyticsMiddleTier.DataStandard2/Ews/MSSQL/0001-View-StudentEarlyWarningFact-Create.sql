...
IF EXISTS (
        ...
        WHERE TABLE_SCHEMA = 'analytics'
            AND TABLE_NAME = 'ews_StudentEarlyWarningFact'
        )
BEGIN
...
SELECT Student.StudentUniqueId AS StudentKey
    ...
    ,MAX(CASE 
            WHEN StudentSectionAttendanceEvent.Id IS NOT NULL
                ...
                AND StudentSectionAssociation.HomeroomIndicator = 1
                THEN 1
            ELSE 0
...
LEFT OUTER JOIN edfi.StudentSectionAssociation
    ON StudentSectionAttendanceEvent.StudentUSI = StudentSectionAssociation.StudentUSI
        ...
        AND StudentSectionAttendanceEvent.ClassPeriodName = StudentSectionAssociation.ClassPeriodName
        AND StudentSectionAttendanceEvent.LocalCourseCode = StudentSectionAssociation.LocalCourseCode
        AND StudentSectionAttendanceEvent.TermDescriptorId = StudentSectionAssociation.TermDescriptorId
...
WHERE CalendarDateCalendarEvent.DATE <= getdate()
