...
DROP VIEW IF EXISTS analytics.asmt_StudentAssessmentObjectiveFact;
...
AS
	SELECT CONCAT(SASOA.StudentUSI, '-', SASOA.IdentificationCode, '-', SASOA.AssessmentIdentifier, '-', SASOA.StudentAssessmentIdentifier, '-', SASOA.Namespace) AS StudentObjectiveAssessmentKey, 
       CONCAT(SASOA.AssessmentIdentifier, '-', SASOA.IdentificationCode, '-', SASOA.Namespace) AS ObjectiveAssessmentKey, 
