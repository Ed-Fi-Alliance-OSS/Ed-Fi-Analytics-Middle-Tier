...
AS
    ...
    LEFT OUTER JOIN
        edfi.StudentEducationOrganizationAssociationStudentIndicator AS InternetAccessInResidence ON
            ...
            AND
            (InternetAccessInResidence.StudentUSI IS NULL or InternetAccessInResidence.IndicatorName = 'Internet Access In Residence')
    LEFT OUTER JOIN
        edfi.StudentEducationOrganizationAssociationStudentIndicator AS InternetAccessTypeInResidence ON
            ...
            AND
            (InternetAccessTypeInResidence.StudentUSI IS NULL or InternetAccessTypeInResidence.IndicatorName = 'Internet Access Type In Residence')
    LEFT OUTER JOIN
        edfi.StudentEducationOrganizationAssociationStudentIndicator AS InternetPerformance ON
            ...
            AND
            (InternetPerformance.StudentUSI IS NULL or InternetPerformance.IndicatorName = 'Internet Performance In Residence')
    LEFT OUTER JOIN
        edfi.StudentEducationOrganizationAssociationStudentIndicator AS DigitalDevice ON
            ...
            AND
            (DigitalDevice.StudentUSI IS NULL or DigitalDevice.IndicatorName = 'Digital Device')
    LEFT OUTER JOIN
        edfi.StudentEducationOrganizationAssociationStudentIndicator AS DeviceAccess ON
            ...
            AND
            (DeviceAccess.StudentUSI IS NULL or DeviceAccess.IndicatorName = 'Device Access')
    WHERE
