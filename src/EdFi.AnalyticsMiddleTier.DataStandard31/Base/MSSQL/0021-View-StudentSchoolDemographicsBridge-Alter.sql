...
WITH StudentSchoolDemographics AS (
    ...
    INNER JOIN 
        edfi.School ON
            StudentEducationOrganizationAssociationCohortYear.EducationOrganizationId = School.LocalEducationAgencyId
    INNER JOIN
    ...
    INNER JOIN 
        edfi.School ON
            StudentEducationOrganizationAssociationDisability.EducationOrganizationId = School.LocalEducationAgencyId
    INNER JOIN
         edfi.StudentEducationOrganizationAssociation ON
    ...
    INNER JOIN 
        edfi.School ON
            StudentEducationOrganizationAssociationDisabilityDesignation.EducationOrganizationId = School.LocalEducationAgencyId
    INNER JOIN
         edfi.StudentEducationOrganizationAssociation ON
    ...
    INNER JOIN 
        edfi.School ON
            StudentEducationOrganizationAssociationLanguage.EducationOrganizationId = School.LocalEducationAgencyId
    INNER JOIN
         edfi.StudentEducationOrganizationAssociation ON
    ...
    INNER JOIN 
        edfi.School ON
            StudentEducationOrganizationAssociationLanguageUse.EducationOrganizationId = School.LocalEducationAgencyId
    INNER JOIN
         edfi.StudentEducationOrganizationAssociation ON
    ...
    INNER JOIN 
        edfi.School ON
            StudentEducationOrganizationAssociationRace.EducationOrganizationId = School.LocalEducationAgencyId
    INNER JOIN
         edfi.StudentEducationOrganizationAssociation ON
    ...
    INNER JOIN 
        edfi.School ON
            StudentEducationOrganizationAssociationTribalAffiliation.EducationOrganizationId = School.LocalEducationAgencyId
    INNER JOIN
         edfi.StudentEducationOrganizationAssociation ON
   ...
   SELECT
    ...
    INNER JOIN 
        edfi.School ON
            StudentEducationOrganizationAssociationStudentCharacteristic.EducationOrganizationId = School.LocalEducationAgencyId
    INNER JOIN
         edfi.StudentEducationOrganizationAssociation ON
	...
	INNER JOIN
		edfi.Student ON
			Student.StudentUsi = StudentEducationOrganizationAssociation.StudentUSI
    INNER JOIN edfi.StudentEducationOrganizationAssociationStudentCharacteristicPeriod ON
