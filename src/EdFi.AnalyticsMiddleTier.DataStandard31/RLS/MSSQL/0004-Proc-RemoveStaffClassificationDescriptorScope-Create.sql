...
IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA = 'analytics_config' AND ROUTINE_NAME = 'rls_RemoveStaffClassificationDescriptorScope')
BEGIN
	DROP PROC [analytics_config].[rls_RemoveStaffClassificationDescriptorScope]
END
GO
