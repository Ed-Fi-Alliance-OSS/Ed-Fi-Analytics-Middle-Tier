...
AS
    ...
    LEFT JOIN edfi.Descriptor AS ReportingMethodDescriptorObjectiveAssessment ON
			ObjectiveAssessmentScore.AssessmentReportingMethodDescriptorId = ReportingMethodDescriptorObjectiveAssessment.DescriptorId
    LEFT JOIN
    ...
    LEFT JOIN
        edfi.ObjectiveAssessmentLearningStandard ON
            ObjectiveAssessment.AssessmentIdentifier = ObjectiveAssessmentLearningStandard.AssessmentIdentifier
            AND
